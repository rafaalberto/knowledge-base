<template>
    <div class="article-admin">
        <b-form>
            ...
            <b-form-group label="Nome:" label-for="articleName">
            <b-form-input id="article-name" type="text" ref="articleName" v-model="article.name" :readonly="mode === 'remove'" required />
            </b-form-group>
            <b-form-group label="Descrição:" label-for="article-description">
                <b-form-input id="article-description" type="text" v-model="article.description" :readonly="mode === 'remove'" required />
            </b-form-group>
            <b-form-group v-if="mode === 'save'" label="Imagem (URL):" label-for="article-imageUrl">
                <b-form-input id="article-imageUrl" type="text" v-model="article.imageUrl" :readonly="mode === 'remove'" required />
            </b-form-group>
